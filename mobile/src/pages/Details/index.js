...
const Details = ({ navigation }) => {
  ...
  const message = `Olá, ${incident.name} gostaria de ajudar no caso "${incident.title}" com o valor de ${formatedValue}`;

  function sendMail() {
    MailComposer.composeAsync({
      subject: `Herói do caso: caso cadelinha atropelada ${incident.title}`,
